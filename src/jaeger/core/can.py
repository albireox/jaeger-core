...
class JaegerCAN(Generic[Bus_co]):
    ...
    ----------
    interface_type
        One of `~jaeger.core.can.INTERFACES`.
    channels
    ...
    interface_type: str
    channels: list | tuple
    fps: Optional[jaeger.core.fps.FPS] = None
    ...
    async def create(
        ...
        fps
            The focal plane system.
        interface_type
            One of `~jaeger.core.can.INTERFACES`. Cannot be used with ``profile``.
        channels
            A list of channels to be used to instantiate the interfaces.
        interface_args
            Keyword arguments to pass to the interfaces when
        ...
        while True:
            ...
            try:
                ...
                if cmd.positioner_ids == [0]:
                    ...
                    continue
            except jaeger.core.JaegerError as ee:
